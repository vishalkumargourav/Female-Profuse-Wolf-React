...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Female Profuse Wolf</title>
        <meta property="og:title" content="Female Profuse Wolf" />
      </Helmet>
      ...
      <div className="home-hero">
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">Protect Your Future</h1>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container13">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">Legal consultation (1 hour)</span>
                </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  A prenuptial agreement, commonly known as a prenup, is a legal
                  document that helps couples protect their assets and define
                  financial responsibilities in the event of divorce or
